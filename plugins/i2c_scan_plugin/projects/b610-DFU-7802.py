...
#   i2c_mux_array -> array-mux-* 行（扫 i2c_1）
#   i2c_mux_base  -> base-mux-*  行（扫 i2c_3）
...
SLOTS = [
    # ---------- 直接扫（不需要切 mux） ----------
    {'key': 'TRIG-I2C5',    'label': 'Trigger板 I2C5', 'scan': 'i2c_5',
     'expected': []},
    {'key': 'WIB-I2C7',     'label': 'WIB板 I2C7', 'scan': 'i2c_7',
     'expected': []},
    # ---------- 先切 array mux(i2c_mux_array) 再扫 i2c_1 ----------
    {'key': 'array-mux-0', 'label': 'array_i2c_1 通道0', 'scan': 'i2c_1',
     'mux': [_mux_op(MUX_SVC_ARRAY, 0)], 'expected': []},
    {'key': 'array-mux-1', 'label': 'array_i2c_1 通道1', 'scan': 'i2c_1',
     'mux': [_mux_op(MUX_SVC_ARRAY, 1)], 'expected': []},
    {'key': 'array-mux-2', 'label': 'array_i2c_1 通道2', 'scan': 'i2c_1',
     'mux': [_mux_op(MUX_SVC_ARRAY, 2)], 'expected': []},
    {'key': 'array-mux-4', 'label': 'array_i2c_1 通道4', 'scan': 'i2c_1',
     'mux': [_mux_op(MUX_SVC_ARRAY, 4)], 'expected': []},
    {'key': 'array-mux-5', 'label': 'array_i2c_1 通道5', 'scan': 'i2c_1',
     'mux': [_mux_op(MUX_SVC_ARRAY, 5)], 'expected': []},
    {'key': 'array-mux-6', 'label': 'array_i2c_1 通道6', 'scan': 'i2c_1',
     'mux': [_mux_op(MUX_SVC_ARRAY, 6)], 'expected': []},
    # ---------- 先切 base mux(i2c_mux_base) 再扫 i2c_3 ----------
    {'key': 'base-mux-0', 'label': 'Base_i2c_3 通道0', 'scan': 'i2c_3',
     'mux': [_mux_op(MUX_SVC_BASE, 0)], 'expected': []},
    {'key': 'base-mux-1', 'label': 'Base_i2c_3 通道1', 'scan': 'i2c_3',
     'mux': [_mux_op(MUX_SVC_BASE, 1)], 'expected': []},
    {'key': 'base-mux-2', 'label': 'Base_i2c_3 通道2', 'scan': 'i2c_3',
     'mux': [_mux_op(MUX_SVC_BASE, 2)], 'expected': []},
    {'key': 'base-mux-4', 'label': 'Base_i2c_3 通道4', 'scan': 'i2c_3',
     'mux': [_mux_op(MUX_SVC_BASE, 4)], 'expected': []},
    {'key': 'base-mux-5', 'label': 'Base_i2c_3 通道5', 'scan': 'i2c_3',
     'mux': [_mux_op(MUX_SVC_BASE, 5)], 'expected': []},
    {'key': 'base-mux-6', 'label': 'Base_i2c_3 通道6', 'scan': 'i2c_3',
